...
# Read events
listOfFiles = ['/store/user/rlopezru/RelValZMM_14/GEN-SIM-RECO/240416_081708/0000/output_{0}.root'.format(i) for i in range(1,20)]
...
process.ntuples.nameOfOutput = '/eos/user/r/rlopezru/MuonReco/TKAlIssue/NTuples_RelValZMM_14_CMSSW_14_1_0_pre2__modified__v1.root'
