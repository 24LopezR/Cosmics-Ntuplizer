...
config.General.requestName = 'CosmicsAnalysis_Run2022C_MiniAOD-Ntuples'
...
config.Data.unitsPerJob = 10 # splitting to get ~500 output files
config.Data.outLFNDirBase = '/store/user/rlopezru/Samples/' # modify accordingly
config.Data.publication = False
config.Data.outputDatasetTag = 'CosmicsAnalysis_Run2022C_MiniAOD-Ntuples'
